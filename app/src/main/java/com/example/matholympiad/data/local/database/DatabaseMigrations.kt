...
object DatabaseMigrations {
 ...
 // Migration 3 -> 4: 添加错题本表（answer_history）
 // 注意：correctAnswerText, hint, module, topic 列已在 MIGRATION_2_3 中创建
 ...
 // Migration 4 -> 5: 空操作（answer_history 表已在 MIGRATION_3_4 中创建）
 // 保留此迁移以维持版本链完整性
 val MIGRATION_4_5_NOOP = object : Migration(4, 5) {
 override fun migrate(database: SupportSQLiteDatabase) {
 // answer_history 表已在 MIGRATION_3_4 中创建，此处无需操作
 }
 }
}
